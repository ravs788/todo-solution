...
test.describe('Utility API Tests', () => {
  ...
  test('should get tag suggestions without search parameter', async ({ request }) => {
  ...
  test('should get tag suggestions with search parameter', async ({ request }) => {
  ...
  test('should get tag suggestions with empty search parameter', async ({ request }) => {
